...
public final class RobustAsmUtils {
     ...
     * @param isStatic
     */
    public static void createInsertCode(GeneratorAdapter mv, String className, List<Type> args, Type returnType, boolean isStatic, String methodName) {
        prepareMethodParameters(mv, className, args, returnType, isStatic, methodName);
        //开始调用
    ...
    private static void prepareMethodParameters(GeneratorAdapter mv, String className, List<Type> args, Type returnType, boolean isStatic, String methodName) {
